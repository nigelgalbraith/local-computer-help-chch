...
IMAGE_PROFILES = {
    ...
    "services": {
        "input_dir": "../services/images/main/original",
...
ASSET_SETS = {
    "thumbs": {
        ...
        "services": {
            "input_dir": "../services/images/thumbs/original",
            "output_dir": "../services/images/thumbs/optimized",
            "width": 400,
            "quality": 85
        }
    },
...
FAVICON_CONFIG = {
    "input": "../images/favicon/original/pc.png",
