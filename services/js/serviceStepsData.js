...
function loadServiceSteps(containerSelector, steps) {
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  // Identify the service type from the <body> data attribute
  const service = document.body.dataset.service;

  // Only proceed if matching service steps exist in serviceSteps JSON
  if (container && serviceSteps[service]) {
    loadServiceSteps(".main-content-step-text section", serviceSteps[service]);
  }
});
